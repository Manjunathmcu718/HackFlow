      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <motion.h2 initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: .1 }}
            ...
            Key{" "}
            <span style={{ background: "linear-gradient(120deg,#F4622A,#FB923C,#F59E0B)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>Dates</span>
          </motion.h2>
        </div>
          ...
          <div className="space-y-5">
            {timeline.map((item, i) => (
              <motion.div key={item.label}
                ...
                <div className="relative z-10 w-12 h-12 rounded-2xl flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform duration-300"
                ...
                <motion.div whileHover={{ x: 5 }} className="card-light flex-1 flex items-center justify-between p-5 rounded-2xl">
                  <div>
